...
public final class CustomTracker implements NativeObject{
    ...
    public CustomTracker(String trackAlgorithm) {
        mNativeAddr = nativeCreateObject(trackAlgorithm);
    }
    ...
    private static native long nativeCreateObject(String trackAlgorithm);
